...
export interface UiContent {
  ...
  headerContactButtonText: string | null;
  headerContactButtonAriaLabel: string | null;
  headerContactButtonTitle: string | null;
  phoneLinkLabelPrefix: string | null;
  footerCopyrightText: string | null;
  footerPrivacyPolicyText: string | null;
  homeHeroEyebrow: string | null;
  homeSocialChannelsEyebrow: string | null;
  homeSocialChannelsTitle: string | null;
  homeHeroCallButtonDescription: string | null;
  homeHeroFormButtonText: string | null;
  homeHeroFormButtonDescription: string | null;
  homeHeroMaxButtonDescription: string | null;
  homeHeroTelegramButtonDescription: string | null;
  homeServicesEyebrow: string | null;
  homeAboutMissionKicker: string | null;
  homeAboutTeamKicker: string | null;
  contactSectionEyebrow: string | null;
  contactSectionLead: string | null;
  contactDetailsPhoneLabel: string | null;
  contactDetailsEmailLabel: string | null;
  contactDetailsHoursLabel: string | null;
  contactFormCardTitle: string | null;
  contactFormCardDescription: string | null;
